...
{
    Route::get('/', ['as' => 'admin.login', 'uses' => 'AuthController@homepage']);
    ...
    Route::group(['middleware' => ['auth.admin'], 'prefix' => 'admin'], function ()
    {
        ...
        Route::get('generates/print/{id}', ['as' => 'admin.generates.print', 'uses' => 'GenetikController@print']);
        Route::get('generates/delete/{id}', ['as' => 'admin.generates.delete', 'uses' => 'GenetikController@delete']);

        Route::get('bagan', ['as' => 'admin.bagan', 'uses' => 'BaganController@index']);
        Route::post('bagan/change/submit', ['as' => 'admin.bagan.change.submit', 'uses' => 'BaganController@submit']);
        Route::get('bagan/result/{id}', ['as' => 'admin.bagan.result', 'uses' => 'BaganController@result']);
        Route::get('bagan/kosong/{id}', ['as' => 'admin.bagan.kosong', 'uses' => 'BaganController@kosong']);
        Route::get('bagan/isi/{id}', ['as' => 'admin.bagan.isi', 'uses' => 'BaganController@isi']);
        Route::get('bagan/change/{day}/{times}/{room}', ['as' => 'admin.bagan.change', 'uses' => 'BaganController@change']);
        Route::get('bagan/print/{id}', ['as' => 'admin.bagan.print', 'uses' => 'BaganController@print']);
        Route::get('bagan/delete/{id}', ['as' => 'admin.bagan.delete', 'uses' => 'BaganController@delete']);


        Route::get('jadwal', ['as' => 'admin.jadwal', 'uses' => 'JadwalController@index']);
        Route::post('jadwal/change/submit', ['as' => 'admin.jadwal.change.submit', 'uses' => 'JadwalController@submit']);
        Route::get('jadwal/result/{id}', ['as' => 'admin.jadwal.result', 'uses' => 'JadwalController@result']);
        Route::get('jadwal/kosong/{id}', ['as' => 'admin.jadwal.kosong', 'uses' => 'JadwalController@kosong']);
        Route::get('jadwal/isi/{id}', ['as' => 'admin.jadwal.isi', 'uses' => 'JadwalController@isi']);
        Route::get('jadwal/change/{day}/{times}/{room}', ['as' => 'admin.jadwal.change', 'uses' => 'JadwalController@change']);
        Route::get('jadwal/print/{id}', ['as' => 'admin.jadwal.print', 'uses' => 'JadwalController@print']);
        Route::get('jadwal/delete/{id}', ['as' => 'admin.jadwal.delete', 'uses' => 'JadwalController@delete']);
