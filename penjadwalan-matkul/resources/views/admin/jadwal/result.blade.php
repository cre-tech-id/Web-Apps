                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-2" style="padding-bottom: 3%;">
                                <a class="btn btn-success btn-block" href="{{ route('admin.generates.excel', $id) }}">
                            ...
                            <div class="col-md-2" style="padding-bottom: 3%;">
                                <a class="btn btn-info btn-block" href="{{ route('admin.generates.print', $id) }}" target="_blank">
                                    <span class="glyphicon glyphicon-download">
                                    </span>
                                    Print
                                </a>
                            ...
                            <div class="col-md-3" style="padding-bottom: 3%;">
                                <a class="btn btn-danger btn-block" href="{{ route('admin.generates.delete', $id) }}">
