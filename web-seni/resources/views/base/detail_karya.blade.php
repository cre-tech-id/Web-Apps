                ...
                <div class="row">
                    <div class="col-lg-12 align-self-center">
                        ...
                        <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s"
                            ...
                            <img src="/storage/upload/karya/{{$k->foto}}" class="card-img-bottom"
                                style="width: 20%; height: 40%; float:left; margin-right: 10px; margin-bottom: 10px; margin-top:10px">
                            <p>{{$k->deskripsi}}</p>
                            <h5>Rp.{{$k->harga}}</h5>
                            <p style="color:#000000">Stok: {{$k->stok}}</p>
                            @if(Session::get('isLoggedin')==true)
                            <button type="button" class="btn btn-primary btn-sm mt-2 pesan_karya" data-bs-toggle="modal"
                            ...
                            <button type="button" class="btn btn-primary btn-sm mt-2 pesan_karya" data-bs-toggle="modal"
                                ...
                                @else
                                <button class="btn btn-primary btn-sm mt-2" href="{{route('login')}}">
                                    @endif
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('tambahpemesanankarya')}}" enctype="multipart/form-data">
                    ...
                    @foreach($karya as $k)
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Jumlah item</label>
                        <input type="number" class="form-control" id="jumlah" name="jumlah" max="{{$k->stok}}">
                    </div>
                    <div class="mb-3" hidden>
                        <input type="text" class="form-control" id="stok" name="stok" value="{{$k->stok}}">
                    </div>
                    <div class="mb-3" hidden>
