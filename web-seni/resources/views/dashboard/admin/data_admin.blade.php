        ...
        <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                    <h3 style="margin-top:15px">Data Admin</h3>
                </div>
            </div>
                ...
                <div class="col-lg-12 mb-4 order-0">
                    <div class="card">
                        <div class="d-flex align-items-end row">
                            <div class="col">
                                <div class="card-body">
                                    <a href="{{route('tambahadmin')}}" class="btn btn-primary mb-3">Tambah
                                        Data</a>
                                    <table id="table" class="table table-bordered" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$a->alamat}}</td>
                                                <!-- <td align="center">
                                                    <a href="/dashboard/editadmin/{{ $a->id }}" class="btn btn-success btn-sm"><i
                                                            class="lnr lnr-pencil"></i>
                                                        Edit</a>
                                                    <a href="/dashboard/hapusadmin/{{ $a->id }}" class="btn btn-danger btn-sm tombol-hapus"><i
