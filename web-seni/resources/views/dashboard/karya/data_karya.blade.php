        ...
        <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                    <h3 style="margin-top:15px">Data Karya</h3>
                </div>
            </div>
                                    ...
                                    <table id="table" class="table table-bordered" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                @if(Session::get('role')==2)
                                                <td align="center">
                                                    <a href="/dashboard/editkarya/{{ $a->id }}" class="btn btn-success btn-sm"><i
                                                            class="lnr lnr-pencil"></i>
                                                        Edit</a>
                                                    <a href="/dashboard/hapuskarya/{{ $a->id }}" class="btn btn-danger btn-sm tombol-hapus"><i
