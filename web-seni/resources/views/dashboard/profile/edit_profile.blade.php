        ...
        <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                    <h3 style="margin-top:15px">Edit Profile</h3>
                </div>
            </div>
                                            ...
                                            @foreach($users as $a)
                                                <form method="POST" enctype="multipart/form-data"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="ttl" name="ttl" value="{{ $a->ttl }}">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="username" class="form-label">Agama</label>
                                                        <input type="text" class="form-control" id="agama" name="agama" value="{{ $a->agama }}">
                                                    </div>
                                                    <div class="mb-3">
