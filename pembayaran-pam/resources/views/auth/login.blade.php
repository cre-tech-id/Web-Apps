...
<div class="wrapper-auth-form d-flex justify-content-center align-items-center">
  <div class="auth-form container d-flex justify-content-center align-items-center">
    <div div class="card p-3">
      <div class="card-body">
        <form action="{{ route('dologin') }}" method="POST" class="form-row align-items-center" >
          @csrf
          <div class="col-12 col-md-6">
            <h1>Masuk</h1>
            <strong>Pengguna Baru?</strong> <a href="/register" class="text-decoration-none">buat akun.</a>
          ...
          <div class="col-md-6 text-center d-none d-md-inline-block">
            ...
            <div class="card col-lg">
              <h2>Silahkan Lakukan Registrasi Jika ingin melakukan Pengajuan Pemasangan Saluran PAM</h2>
            </div>
          </div>
        </form>
      </div>
