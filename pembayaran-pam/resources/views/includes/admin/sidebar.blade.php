<div id="sidebar" class="sidenav">
  ...
  {{-- <!-- @can('pln_customer_access')
    <a href="{{route('pelaporans.index')}}" class="sidebar-item {{ Route::is('pelaporans.*') ? 'active' : '' }}">
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
        <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
      </svg>
      Pelaporan
  ...
  @can('pln_customer_access')
    <a href="{{route('pemasangans.index')}}" class="sidebar-item {{ Route::is('pemasangans.*') ? 'active' : '' }}">
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
        <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
      </svg>
      Pemasangan
  ...
  @can('pln_customer_access')
    <a href="{{route('pemutusans.index')}}" class="sidebar-item {{ Route::is('pemutusans.*') ? 'active' : '' }}">
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
        <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
      </svg>
      Pemutusan
