      ...
      <form action="{{ route('admin.pln-customers.update', $plnCustomer->id)}} " method="POST">
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" name="nomor_meter" class="form-control @error('nomor_meter') is-invalid @enderror" id="inputNoMeter" placeholder="Contoh: 537320018426" value="{{ $plnCustomer->nomor_meter }}">
