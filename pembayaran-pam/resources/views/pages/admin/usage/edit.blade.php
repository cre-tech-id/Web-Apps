...
@section('content')
  <div class="container">
    ...
    <div class="card">
      <div class="card-body">
        <form action="{{route('update_penggunaan')}}" method="POST">
          @csrf
          @method('PUT')
          ...
          <div class="form-group">
            ...
            >
              ...
              @foreach($pelanggan as $pelanggan)
                <option value="{{ $pelanggan->id }}" {{ ($pelanggan->id == $usage->id_pelanggan) ? 'selected' : '' }}>
          ...
          @endforeach
          <a href="{{ route('admin') }}" class="btn btn-danger mr-1">Batal</a>
