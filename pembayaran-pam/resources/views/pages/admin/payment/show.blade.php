...
@section('content')
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <dl class="row">
              ...
              <dt class="col-md-4">Nama Pelanggan PAMSIMAS</dt>
              ...
              <dt class="col-md-4">Struk Pembayaran</dt>
              <dd class="col-md-8">
                @if ($payment->bukti_bayar)
                  <a href="#previewReceiptOfPayment" data-toggle="modal"><img
                      src="{{ Storage::url($payment->bukti_bayar) }}" class="img-fluid img-thumbnail" width="400"
                      height="400"></a>
                @else
                  -
                @endif
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <dl class="row">
              ...
              <dt class="col-md-4">Tarif</dt>
              <dd class="col-md-8">
                {{ $payment->plnCustomer->tariff->tarif_per_kwh }} 
              </dd>
            </dl>
          </div>
        </div>
  ...
  @if ($payment->bukti_bayar)
    <div class="modal" tabindex="-1" id="previewReceiptOfPayment" style="z-index: 9999">
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <img src="{{ Storage::url($payment->bukti_bayar) }}" class="img-fluid img-thumbnail">
          </div>
        </div>
      </div>
    </div>
