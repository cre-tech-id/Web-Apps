      ...
      <form action="{{ route('admin.pln-customers.update', $plnCustomer->id)}} " method="POST">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input disabled type="text" name="nama_pelanggan" class="form-control" id="inputNama" placeholder="Masukkan nama" value="{{ $plnCustomer->nama_pelanggan }}">
          </div>
          <div class="form-group col-md-6">
            <label for="inputNoMeter">No. Meter / ID Pelanggan</label>
            <input disabled type="text" name="nomor_meter" class="form-control @error('nomor_meter') is-invalid @enderror" id="inputNoMeter" placeholder="Contoh: 537320018426" value="{{ $plnCustomer->nomor_meter }}">
        ...
        <div class="form-group">
          ...
          <textarea disabled name="alamat" class="form-control" id="inputAlamat" placeholder="Masukkan alamat">{{ $plnCustomer->alamat }}</textarea>
        </div>
        {{-- <div class="form-group">
