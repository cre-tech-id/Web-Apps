  ...
  <div class="container">
    ...
    <div class="card">
      ...
      <form action="{{ route('penggunaan.store') }}" method="POST">
        ...
        <div class="form-group">
          <label for="selectKota">Desa <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="selectGolonganTarif"> Tarif <span class="text-danger">*</span></label>
          ...
          @enderror" id="selectGolonganTarif" data-live-search="true">
            ...
            @foreach($tariffs as $tariff)
              <option value="{{ $tariff->id }}" {{ $tariff->id === old('id_tarif') ? 'selected' : '' }}>{{ $tariff->tarif_per_kwh}} </option>
            @endforeach
          </select>
