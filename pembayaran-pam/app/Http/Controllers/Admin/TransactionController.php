...
class TransactionController extends Controller
{
    ...
    public function __construct()
    {
       ...
       // Config::$serverKey = config("midtrans.serverKey");
        ...
        Config::$serverKey = 'SB-Mid-server-EVpH_mRLq06mKaNa5ObqgNRw';
    ...
    {
        try {
            $response = MidtransTransaction::status("PAMSIMAS-".$payment->id);
    ...
    public function changePaymentMethod(Payment $payment)
    {
        ...
        try {
            MidtransTransaction::cancel('PAMSIMAS-'.$payment->id);
        } catch (Exception $ex) {
    ...
    {
        $transaction = MidtransTransaction::status("PAMSIMAS-".$payment->id);
