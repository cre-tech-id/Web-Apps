...
<div class="row">
	<div class="col-md-6">
		<div style="margin-bottom: 20px;" class="pull-left">
			...
			<a href="cetak/cetakassosiasi.php" class="btn btn-warning btn-sm"><i class="glyphicon glyphicon-file"></i> Buat laporan</a>
		</div>
	</div>
	<div class="col-md-6">
		<div style="margin-bottom: 20px;" class="pull-right">

			<a href="#" class="modal_laku btn btn-warning btn-sm"></i> Produk Paling Laku</a>
			<a href="#" class="modal_ket btn btn-info btn-sm"></i> Produk Kurang Laku</a>
...
while ($d = mysqli_fetch_array($sql_menu)) {
	...
	$conf2 = getSupport($con, $kodekanan);
	if ($conf2 == 0) {
		$conf2 = getSupport($con, $kodekanan2) + 0;
	}
...
while ($d = mysqli_fetch_array($sql_menu)) {
	...
	if ($conf2 == 0) {
		$conf2 = getSupport($con, $kodekanan3) + 0;
	}
