...
<div class="row" style="padding-top: 30px;">
	<div class="col-lg-12">
		...
		<div class="alert alert-info" role="alert" style="font-size: 18px; font-family: cursive;">
			<span class="glyphicon glyphicon-dashboard" aria-hidden="true"></span> kategori Barang
		</div>
	</div>
</div>
<div class="row">
			...
			<form method="post" name="proses">
				<table class="table table-striped table-bordered table-hover" id="datatables">
					...
					<tbody>
						<?php
						$no = 1;
						$sql_menu = mysqli_query($con, "SELECT a.kd_menu, a.menu,  c.jenis, b.kategori, a.stok, a.harga, a.gambar FROM tb_menu a, tb_kategori b, tb_jenis c WHERE a.kd_kategori = b.kd_kategori AND b.kd_jenis = c.kd_jenis order by kd_menu asc") or die(Mysqli_error($con));
		...
		$(".modal_edit").click(function(e) {
			...
			$.ajax({
				...
				success: function(ajaxData) {
					...
					$("#Modal #modal-edit #pict").attr("src", "../../_assets/img/menu/" + gambar);
				}
			});
		});
	});
