              ...
              <div class="modal-body" id="modal-edit">
                  <form action="proses.php" name="modal_popup" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="col-lg-12">
                              <ol class="breadcrumb alert-info">
                                  <li class="active" style="font-size: 16px;">
                                      <i class="fa fa-info-circle"></i> Kode Barang : <b><em><u><?php echo $r['kd_menu']; ?></u></em></b>
                                  </li>
                              </ol>
                          </div>
                      </div>
                      <div class="form-group" style="padding-bottom: 20px;">
                          <label for="menu">Nama Barang</label>
                      ...
                      <div class="form-group" style="padding-bottom: 20px;">
                          ...
                          <input type="number" name="stok" id="stok" class="form-control" value="<?php echo $r['stok']; ?>" required>
                      </div>
                      <div class="form-group" style="padding-bottom: 20px;">
                      ...
                      <div class="form-group" style="padding-bottom: 20px;">
                          ...
                          <div style="padding-bottom: 20px;">
                              <img src="" width="150px" id="pict" name="pict">
                          </div>
