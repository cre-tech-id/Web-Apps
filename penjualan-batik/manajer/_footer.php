		        ...
		        <div class="modal-body">
		        	<form action="" name="modal_popup" method="POST">
		                ...
		                <div class="form-group" style="padding-bottom: 20px;">
		                	...
		                	<input type="hidden" name="kd_akun" id="kd_akun"  class="form-control" value="<?=$r['kd_akun'];?>">
		                    <input type="text" readonly="" name="username" id="username"  class="form-control" value="<?=$r['username'];?>">
		                </div>
			            ...
			            <div class="modal-footer">
			                ...
			                <button class="btn btn-success btn-sm" type="submit" name="submit" data-toggle="modal" data-target="#contohModalKecil">
