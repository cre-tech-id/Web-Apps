...
<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="cetak/cetakpernota.php" method="POST" target="_blank">
                <div class="container-fluid">
                    <div class="row" style="padding-left: 15px;">
                        <div class="col-md-4"><label>
                                <p style="font-size: 17px;"> Nomor Nota </p>
                            </label></div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <ol class="breadcrumb">
                                <li class="active" style="font-size: 17px;">
                                    ...
                                    <input type="hidden" name="nota" id="nota" class="form-control" value="<?php echo $total['nonota']; ?>">
                                </li>
                            </ol>
                        </div>
                        <div class="col-md-4">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <?php while ($r = mysqli_fetch_array($query_mysql)) { ?>
                                ...
                                <tr>
                                    ...
                                    <td colspan='4'>
                                        <h4>Rp. <?php echo number_format($total['total'], 2, ",", "."); ?></h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan='4'>
                                        <h4 align='right'>Bayar</h4>
                                    </td>
                                    <td colspan='4'>
                                        <h4>Rp. <?php echo number_format($total['bayar'], 2, ",", "."); ?></h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan='4'>
                                        <h4 align='right'>Kembalian</h4>
                                    </td>
                                    <td colspan='5'>
                                        <h4>Rp. <?php echo number_format($total['kembalian'], 2, ",", "."); ?></h4>
                                    </td>
                                </tr>
                                </tbody>
                        </table>
                ...
                <div class="modal-footer">
                    ...
                    <a href="cetak/cetakpernota.php?nonota=<?php echo $nonota; ?> " class="btn btn-success"><i class="fa fa-fw fa-print"></i> Cetak</a>
                </div>
            </form>
        </div>
    </div>
